...
import de.jeff_media.chestsort.data.PlayerSetting.DoubleClickType;
...
public class PlayerSetting {
	...
	public DoubleClickType getCurrentDoubleClick(ChestSortPlugin plugin, DoubleClickType click) {
		...
		Bukkit.getGlobalRegionScheduler().runDelayed(plugin, scheduledTask -> {currentDoubleClick = DoubleClickType.NONE;}, 10L);
